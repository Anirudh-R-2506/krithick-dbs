...
BEGIN
    ...
    ELSE
        ...
        END CASE;
        INSERT INTO DONOR VALUES(v_cusID, v_name, in_volume, in_bankname, SYSDATE, CURRENT_TIMESTAMP)
        dbms_output.put_line('Blood donated successfully');
    END IF;
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
            dbms_output.put_line('Invalid donor details');
        WHEN OTHERS THEN
